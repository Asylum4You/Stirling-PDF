...
CMD ["sh", "-c", "java -Dfile.encoding=UTF-8 -Dserver.port=8080 -Djava.io.tmpdir=/tmp/stirling-pdf -jar /app.jar & /opt/venv/bin/unoserver --port 2003 --interface 127.0.0.1"]
